...
def generate_a2c_distance_lstm(
    ...
    run_builder = (
        ...
        .set_run_name("a2c_distance_lstm")
    )
    ...
    shared_builder = DistanceNeuralNetwork.Builder(
    ...
    normal_memory = A2CAgent.Builder(
        env_name="pursuer_0",
        name="a2c_distance_lstm_normal_memory",
        batch_size=512,
        memory=512 * 3,
