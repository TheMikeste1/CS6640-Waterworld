...
def generate_qnn_simple_lstm(
    ...
    qnn_normal_memory = QNNAgent.Builder(
        env_name="pursuer_0",
        name="qnn_simple_lstm_normal_memory",
        batch_size=512,
        memory=512 * 3,
